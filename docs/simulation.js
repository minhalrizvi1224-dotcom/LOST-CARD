...
const SCENARIOS = [
  { hani: ["Hey. You free this evening? I found that old photo. The one from the roof.", "Hey. Free tonight? I came across that old photo — the one from the roof.", "Hey. Found that old roof photo while clearing out a drawer. You around this evening?"], subtext: "(He's been looking at it for twenty minutes before texting. He won't say that.)", conflict: "Dismissing a memory", salvation: false,
    soft: ["The roof. I haven't thought about that night in years. Send it?", "Yeah, I'm free. And honestly… I'd really like to see it.", "God, the roof one. We were so young. Send it, I want to see our faces.", "The roof photo? Yeah, I'm around. I'd love to see it.", "That night on the roof. Send it over — and yeah, let's actually catch up.", "Oh man, the roof. I'm free tonight. It's been too long."],
    aggressive: ["Why are you going through old photos right now?", "Kind of swamped tonight. Everything okay though?", "That was forever ago. What made you think of it?", "Old photos, out of nowhere? That's a bit random.", "I might be busy. Why, what's going on?", "We really doing the nostalgia thing tonight?"],
    silent: ["Oh. What about it?", "Random. Anyway.", "Maybe. Depends how the night goes.", "K.", "Cool, I guess.", "We'll see."] },

  { hani: ["I was just cleaning up and it came up. We looked so - I don't know. Less complicated.", "I was tidying and it turned up. We looked so… I don't know. Less complicated.", "It came up while I was clearing things out. We looked lighter back then. Less complicated."], subtext: "(He almost said 'happy'. He stopped himself. He doesn't know why.)", conflict: "Invalidating nostalgia", salvation: false,
    soft: ["We were lighter then. I miss that, more than I let on.", "Less complicated. Yeah. When did everything get so heavy with us?", "We really did look it. What happened to those two, Hani?", "God, we did look lighter. I miss who we were then.", "Less complicated — yeah. I've felt how far we've drifted from that.", "We were easier back then. When did that go?"],
    aggressive: ["Everyone looks happy in old photos. Don't read into it.", "Things get complicated. That's just life, not some tragedy.", "This is kind of a strange thing to text me about.", "It's an old photo, Hani. Don't spiral on it.", "Everything looks simpler in hindsight. Means nothing.", "Why are we analysing a picture?"],
    silent: ["Yeah, I guess.", "Hm.", "People change. It's fine.", "Okay.", "Sure.", "If you say so."] },

  { hani: ["I called you three times last week. You picked up once, said you'd call back in five minutes. That was three weeks ago.", "I called three times last week. One pickup, a 'five minutes,' then three weeks of silence.", "Three calls last week. You answered once and said you'd ring back in five. That was three weeks ago."], subtext: "(He counted. He wasn't going to say that. He just did.)", conflict: "Being called out on absence", salvation: true,
    soft: ["You're right. I said five minutes and just… didn't. That wasn't okay.", "Three weeks. God. I didn't even clock it. I'm sorry, Hani.", "I keep leaving you on read in real life, don't I. I hate that I do that.", "That's a fair hit. I left you hanging and didn't notice.", "I do that and then wonder why you stop calling. I'm sorry.", "Five minutes that turned into three weeks. That's on me."],
    aggressive: ["I've been busy. Not everyone can drop everything to talk.", "Are you actually keeping count of my calls now?", "You could've called back too. It's not all on me.", "Life's been a lot. Cut me some slack.", "You're really timing my callbacks now?", "I forgot. It happens to people."],
    silent: ["Things have been hectic.", "I'll call you this week sometime.", "It slipped my mind, that's all.", "Been busy.", "I'll get to it.", "Noted."] },

  { hani: ["It's not about the calls. I don't need you to call me every day. I just - when I actually reach out, I want it to mean something.", "It's not about how often you call. When I actually reach out, I just want it to land somewhere.", "I don't need you every day. I just need it to mean something when I do reach for you."], subtext: "(He's been rehearsing this. Not the words - the courage to say them.)", conflict: "Minimizing his need", salvation: true,
    soft: ["It does mean something. I've just been awful at acting like it.", "You're right. When you reach for me, you should feel caught. You haven't been.", "That's not too much to ask. It's the bare minimum, and I missed it.", "It should land somewhere. With me it hasn't, and that's my failure.", "You deserve to feel like reaching me is worth it. Lately it wasn't.", "Fair. I've made reaching out feel pointless. I'll change that."],
    aggressive: ["That's a lot of weight to put on a phone call.", "So every text has to 'mean something' now? That's exhausting.", "I think you're reading way too much into this.", "Everything has to be deep with you lately.", "It's a text, Hani. Not a vow.", "You're turning a phone call into a referendum on us."],
    silent: ["Okay.", "I mean… it does, I guess.", "Sure. Noted.", "Right.", "Whatever you need.", "Mm."] },

  { hani: ["Do you remember what you said the last time we actually talked - properly talked? You said things were going to be different.", "Do you remember the last time we really talked? You promised things would be different.", "Last time we properly talked, you said it'd be different. Do you remember that?"], subtext: "(He believed it when she said it. That's the part that hurts.)", conflict: "Broken promise unaddressed", salvation: false,
    soft: ["I remember. I meant it too. I just… didn't do it. That's on me.", "I said it and then let it slide right back. You believed me. I get why that stings.", "I do remember. And I'm sorry I turned it into just words.", "I remember the promise. And I remember not keeping it. I'm sorry.", "You held onto that because I made it sound real. Then I vanished.", "I said it and did nothing. That's the part I can't defend."],
    aggressive: ["People say things in the moment. You can't hold me to all of it.", "I'm not going to get cross-examined over something from months ago.", "Things did change. Just maybe not how you wanted them to.", "I'm not going to be quoted back to myself.", "That was then. Circumstances change.", "You remember every single thing I've ever said, don't you."],
    silent: ["Vaguely.", "Did I? Don't really remember.", "That was ages ago.", "Kind of.", "Maybe.", "It was a while back."] },

  { hani: ["I'm not trying to make you feel bad. I just think I've been pretending everything is fine for a while now. And it's - tiring.", "I'm not guilt-tripping you. I've just been faking 'fine' for ages, and it's exhausting.", "This isn't about making you feel bad. I've pretended things were okay for so long and I'm tired."], subtext: "(He's been waiting to say this. Not to punish her. Just to stop carrying it alone.)", conflict: "Deflecting his honesty", salvation: true,
    soft: ["You shouldn't have to perform 'fine' with me of all people. Just tell me.", "You've been holding that by yourself. You don't have to anymore.", "Thank you for actually saying it instead of fading out on me too.", "Be tired with me. I can hold it. You don't have to act around me.", "I hate that you've had to fake it with me. Stop. Tell me the real thing.", "That took more than you'd think to admit. Thank you for trusting me with it."],
    aggressive: ["So you've been faking it this whole time. Good to know.", "If it's so tiring, why are you even still here?", "Don't hand me your exhaustion. I never asked you to pretend.", "So all this time you were lying about being okay?", "You think this is easy for me either?", "Don't put your exhaustion on me like I caused it."],
    silent: ["Okay. That's fair, I suppose.", "Hm. Alright.", "If you say so.", "Okay.", "Fair enough.", "Right."] },

  { hani: ["I think I've been lonely. Not in general. Specifically when I'm talking to you.", "I think I've been lonely. Not in life — specifically when it's you and me talking.", "Lately I've felt lonely. Not in general. Just… when I'm talking to you."], subtext: "(He said it. He didn't plan to say it today. He can't take it back.)", conflict: "Contradicting his experience", salvation: true,
    soft: ["Lonely while you're talking to me. That's… that's a hard thing to hear, and I needed to.", "I've been right here and somehow still left you alone. I'm sorry.", "I never wanted to be the person who made you feel that. Tell me when it started.", "That's a brave thing to admit. I never want to be your loneliest conversation.", "Lonely with me — that's the saddest thing, and I caused it. I'm sorry.", "Help me understand how I got there. I want you to feel less alone with me."],
    aggressive: ["How are you lonely when I'm literally talking to you right now?", "That doesn't even make sense, Hani.", "That sounds like something you need to work on, not me.", "I'm right here. How is that lonely?", "That's a strange thing to put on me.", "Maybe that's a you thing, not a me thing."],
    silent: ["That's… a lot.", "Okay.", "I don't really know what to say to that.", "That's heavy.", "Hm.", "I don't know what to say."] },

  { hani: ["I used to tell you things I didn't tell anyone else. I stopped. I'm not sure exactly when.", "I used to tell you things I told no one else. Then I stopped. Not sure exactly when.", "There were things only you ever heard. Somewhere along the way I stopped. I don't know when."], subtext: "(He knows exactly when. He's protecting her from knowing.)", conflict: "Dismissing trust erosion", salvation: false,
    soft: ["You used to. I felt like the one you trusted. I want to be that again.", "You went quiet and I never once asked why. I should have noticed.", "When did you stop? I really want to know what I missed in you.", "You trusted me with the unsaid things once. I want to be that safe again.", "I let that trust quietly erode and never noticed. That's on me.", "I miss being the one you told. Tell me how to get back there."],
    aggressive: ["Maybe you just outgrew oversharing. Happens to everyone.", "You stopped on your own. Don't pin that on me.", "So that's my fault now too? Of course it is.", "Maybe you just grew up. People share less.", "That's not something I can control, Hani.", "Why is everything framed as my fault?"],
    silent: ["People stop sharing. It's normal.", "Huh.", "Didn't really notice, to be honest.", "Things change.", "Okay.", "Hadn't noticed."] },

  { hani: ["There was a night - I don't remember the exact date - where I was genuinely not okay. And I opened your chat and just closed it again.", "There was a night I really wasn't okay. I opened your chat, stared at it, and closed it again.", "One night I was genuinely not alright. I opened our chat and couldn't bring myself to type. Closed it."], subtext: "(That night was six months ago. He remembers the exact date.)", conflict: "Blaming him for his own silence", salvation: true,
    soft: ["You needed me and you couldn't even type the message. That's what I did to us. I'm so sorry.", "You opened my name and closed it. God. I made myself that unsafe to reach.", "I wish you'd hit send. But I understand why you couldn't. That part is mine.", "You reached for me and I'd made myself impossible to reach. I'm sorry.", "That you couldn't even type it tells me how far I'd pulled away.", "You shouldn't have faced that night alone. I'll carry that."],
    aggressive: ["Well if you never messaged me, how was I supposed to know?", "You're the one who closed the chat. That's not on me.", "You can't be upset about a text you didn't even send.", "I can't help with a message you never sent.", "You closed it yourself, Hani.", "How is your silence somehow my fault?"],
    silent: ["Oh.", "That's rough, I guess.", "You should've just messaged me.", "Oh.", "That's hard.", "You could've reached out."] },

  { hani: ["Because I'd done it before. Reached out. And you were - you were there, but not there. Physically responding, emotionally somewhere else.", "Because I'd tried before. You'd reply, sure. But you were never really present for it.", "I'd reached out before. You were there — answering — but somewhere else entirely."], subtext: "(He's never said this to anyone. He's terrified she's going to get defensive.)", conflict: "Defending unavailability", salvation: false,
    soft: ["There but not there. That's exactly what I was. And you felt every bit of it.", "You stopped reaching because I never actually caught you. That's fair.", "I gave you half of me and called it showing up. You deserved the whole thing.", "Present but absent — that was me. You stopped trusting it. Rightly.", "You learned my 'here' wasn't really here. I want to fix that.", "I answered without arriving. You deserved someone who arrived."],
    aggressive: ["I always answered. What more do you want from me?", "So even when I'm right here it's wrong now? Great.", "Maybe that's just how I am. Take it or leave it.", "I literally always replied. What else do you want?", "So my showing up is wrong now too?", "That's just how I text. Deal with it."],
    silent: ["I was answering, though.", "Okay.", "I genuinely don't see the difference.", "I replied, though.", "Right.", "Don't see the difference."] },

  { hani: ["I'm not asking for 24/7. I'm asking for the one time I actually needed you. Just that one time.", "I don't want all your time. I wanted you there the one time it actually mattered.", "Not every day. Just the once I genuinely needed you. That's all I'm asking."], subtext: "(He's shaking slightly. He's kept this in for a very long time.)", conflict: "Minimizing a specific wound", salvation: true,
    soft: ["The one time it counted, I wasn't there. I can't take that back. I can be different now.", "You're asking for so little. And I still managed to miss it. I'm sorry.", "That night lives in me too. I want to be someone you can actually lean on.", "The one time that counted, I missed it. I can only do better from here.", "You asked for almost nothing and I still wasn't there. I'm sorry.", "That one time matters to me too now. Let me be someone you can lean on."],
    aggressive: ["One time? You're going to define everything by a single night?", "Nobody's perfect. You've missed things for me too, you know.", "That's a bit dramatic. It was one moment.", "One moment and that's the whole story now?", "You've missed things for me too, remember.", "That's a bit much for one night."],
    silent: ["Okay.", "Fair enough, I suppose.", "Noted.", "Okay.", "Fair, I suppose.", "Right."] },

  { hani: ["The thing is - I still wanted to talk to you. After everything. That's what I can't explain.", "Even after all of it, I still wanted to talk to you. I can't even explain why.", "The thing I can't explain is that, after everything, I still wanted you around."], subtext: "(He's trying to say: I still chose you. He doesn't know if that's strength or stupidity.)", conflict: "Missing the weight of his loyalty", salvation: false,
    soft: ["You kept choosing me even after I gave you every reason not to. That undoes me a little.", "After all of it, you still wanted me around. I won't waste that again.", "That's not stupidity, Hani. That's you being loyal. And I haven't earned it.", "You kept the door open when you had every reason to shut it. That undoes me.", "After everything, you still wanted me. I won't squander that again.", "That's loyalty, not weakness. And I haven't matched it."],
    aggressive: ["Then why are we doing this whole guilt-trip then?", "Funny way of showing you still want to talk.", "So are you mad at me or not? Pick one.", "Then why the whole guilt trip first?", "Strange way to show you still want to talk.", "Are you angry or not? I can't keep up."],
    silent: ["Right.", "Okay. Same, I guess.", "Cool.", "Right.", "Same, I suppose.", "Okay."] },

  { hani: ["I just need to know if this is still something you're invested in. Because I can't keep guessing.", "I just need to know you're still in this. Because I can't keep guessing.", "I need to know if you're still invested. I can't keep guessing at it."], subtext: "(He's asked himself this question fifty times. He's finally asking her.)", conflict: "Demanding proof without giving it", salvation: true,
    soft: ["I'm in. I know I haven't acted like it — let me start tonight.", "You shouldn't have to guess where you stand with me. You're not a maybe.", "Yes. And I know words are cheap right now. So hold me to it.", "I'm in. I'll prove it instead of just saying it.", "You're not a maybe to me. You shouldn't feel like one.", "Yes. Hold me to it, because I know saying it isn't enough."],
    aggressive: ["I'm here, aren't I? What more do you want?", "You can't just demand a guarantee. That's not how people work.", "Why is it suddenly my job to convince you?", "I showed up, didn't I? What more do you need?", "You can't demand a guarantee like that.", "Why's the burden of proof on me?"],
    silent: ["I mean, yeah.", "Of course.", "I guess so.", "Yeah.", "Of course.", "I guess."] },

  { hani: ["Because I stopped assuming. That's what happens when things shift and no one acknowledges it.", "Because I stopped assuming. That's what happens when everything shifts and nobody names it.", "I stopped assuming. That's what happens when things change and no one says so."], subtext: "(He's watched too many people leave without ever saying they were leaving.)", conflict: "Excusing drift as inevitable", salvation: false,
    soft: ["You stopped assuming because I never once reassured you. I let silence do my talking.", "Things changed and I said nothing. That quiet is what took your certainty. I'm sorry.", "You deserved someone to name it out loud. So — I'm naming it. I drifted, and it was wrong.", "You stopped assuming because I never reassured you. My silence did that.", "I let it shift and said nothing. That cost you your certainty. I'm sorry.", "You deserved me to name it. So — I drifted. It was wrong."],
    aggressive: ["Things shift. That's just how it goes. Stop romanticizing it.", "You assumed the worst. That's the actual problem here.", "Not everything needs some big announcement.", "Things shift. Stop romanticizing it.", "You assumed the worst — that's the real issue.", "Not everything needs an announcement."],
    silent: ["I suppose.", "Mm.", "That's just life, isn't it.", "I suppose.", "Mm.", "That's life."] },

  { hani: ["I just - I wish you'd told me you were drifting instead of making me feel like I was imagining it.", "I wish you'd just said you were drifting, instead of making me feel like I imagined it.", "I just wish you'd told me you were pulling away, not made me feel crazy for noticing."], subtext: "(He felt crazy for a while. He's only recently understood he wasn't.)", conflict: "Gaslighting response", salvation: true,
    soft: ["You weren't imagining anything. You were right, and I let you doubt yourself anyway. I'm sorry.", "I made you question your own gut just so I wouldn't have to be honest. That was cowardly.", "You saw it before I'd admit it. You weren't crazy. You were paying attention.", "You weren't imagining it. You were right, and I let you doubt yourself. Sorry.", "I made you question your gut to dodge an honest talk. That was cowardly.", "You weren't crazy. You were paying attention. I'm sorry I hid from it."],
    aggressive: ["Honestly? You were imagining half of it.", "I never said anything was wrong, so don't act like I lied to you.", "You're rewriting the whole thing to make me the bad guy.", "You were imagining half of it, honestly.", "I never said anything was wrong. Don't call it lying.", "You're rewriting it to cast me as the villain."],
    silent: ["Maybe.", "If that's how you saw it.", "Okay.", "Maybe.", "If that's how it looked to you.", "Okay."] },

  { hani: ["What would it take. Actually. For this to be what it used to be.", "What would it actually take — for us to be what we used to be?", "What would it really take for this to feel like it used to?"], subtext: "(He doesn't think it's possible. He's asking anyway. For closure if nothing else.)", conflict: "Closing the door on repair", salvation: true,
    soft: ["Me showing up. Over and over, until you stop bracing for me to vanish. I'll do it.", "Time. And me proving it instead of promising it. I want to try for real this time.", "It'd take me being the friend you needed back then. Let me become him.", "Me showing up until you stop expecting me to disappear. I'll do that.", "Time, and proof instead of promises. I want to actually try.", "Me becoming the friend you needed back then. Let me."],
    aggressive: ["Maybe it just can't go back. Some things don't.", "I don't know. Maybe nothing. Maybe it's run its course.", "Why is fixing all of it suddenly on me?", "Maybe it just can't go back.", "I don't know. Maybe nothing. Maybe it's over.", "Why's fixing all of it on me?"],
    silent: ["I don't know.", "Hard to say.", "We'll see, I guess.", "I don't know.", "Hard to say.", "We'll see."] },

  { hani: ["I'm not sure I believe that anymore. Not because of you - because of how many times I've believed it.", "I'm not sure I believe it now. Not your fault — I've just believed it too many times.", "I don't know if I believe that anymore. Not because of you. Because of how often I have."], subtext: "(He's not angry. He's tired. That's worse.)", conflict: "Confirming hopelessness", salvation: false,
    soft: ["You've believed me before and I let it rot. So I won't ask for faith — I'll just show you.", "Your tiredness makes total sense. Let me earn it back slow, no promises this time.", "I don't blame you for not believing me. Watch what I do instead of what I say.", "You believed me before and I let it rot. No promises — I'll just show you.", "Your tiredness makes sense. Let me earn it back slowly.", "I don't blame you. Watch what I do, not what I say."],
    aggressive: ["Then why even talk to me if you've already decided?", "So nothing I say counts now. Got it.", "You've basically given up already. That's on you, not me.", "Then why talk to me if you've already decided?", "So nothing I say counts now. Got it.", "You've already given up. That's on you."],
    silent: ["Okay.", "Fair.", "Understood.", "Okay.", "Fair.", "Understood."] },

  { hani: ["Maybe some friendships just have a natural end. Maybe this is it.", "Maybe friendships just run their course. Maybe we've hit ours.", "Maybe some things just end on their own. Maybe this is one of them."], subtext: "(He doesn't believe this. He's testing if she does.)", conflict: "Accepting dissolution", salvation: true,
    soft: ["I don't think this is it. I'm not ready to let us just quietly end.", "Some friendships do end. But ours wouldn't be ending — it'd be me letting it starve.", "Don't. I'd rather fight for this than watch it go cold.", "I don't think this is it. I'm not ready to let us fade.", "Some end. Ours would just be me letting it starve — that's not natural.", "Don't. I'd rather fight for this than watch it die."],
    aggressive: ["Maybe you're right. Maybe we should stop forcing it.", "If that's what you want, then fine.", "Yeah. Maybe it has just run its course.", "Maybe you're right. Let's stop forcing it.", "If that's what you want, fine.", "Yeah, maybe it's run its course."],
    silent: ["Maybe.", "Could be.", "If you think so.", "Maybe.", "Could be.", "If you say so."] },

  { hani: ["You know what I keep thinking about? That moment on the roof. Before all of this. We didn't need to say anything.", "You know what I keep coming back to? The roof. Before all this. We didn't need words.", "I keep thinking about that night on the roof. Before everything. We didn't need to say anything."], subtext: "(He's grieving something that is still technically alive.)", conflict: "Erasing the memory", salvation: false,
    soft: ["The roof. We could just sit there in silence and it was enough. I want that back.", "I think about it too. We were so easy with each other. I miss being that easy.", "That night mattered to me. It still does. It's not just yours.", "The roof. Silence with you was enough back then. I want that ease again.", "I think about it constantly. We were so easy together. I miss that.", "That night meant something to me too. It still does."],
    aggressive: ["That was years ago. We're not those people anymore.", "Why do you keep going back to that roof? It's done.", "Living in the past won't fix any of this.", "That was years ago. We're different people now.", "Why do you keep returning to that roof?", "Nostalgia won't fix any of this."],
    silent: ["Yeah.", "Barely remember it, honestly.", "That was a long time ago.", "Yeah.", "Barely remember it.", "Long time ago."] },

  { hani: ["I'm going to be honest. If we stop talking now - I don't think I'd reach out again. I've done the reaching.", "Honestly? If we stop now, I won't reach out again. I've been the one reaching all along.", "I'll be honest. If we stop talking now, I won't try again. I've done the reaching."], subtext: "(He means it. He's not saying it to hurt her. He's saying it so she understands the weight.)", conflict: "Conceding the loss", salvation: true,
    soft: ["You've done all the reaching for too long. It's my turn now. I'm not letting this go quiet.", "I hear how heavy that is. You shouldn't have been the only one trying. Let me reach.", "Then you won't have to reach again. I'll be the one showing up this time. I mean it.", "You've reached for too long. It's my turn. I won't let this go quiet.", "You shouldn't have been the only one trying. Let me reach now.", "You won't have to reach again. I'll show up this time. I mean it."],
    aggressive: ["So this is an ultimatum now?", "Fine. Then don't. Let's see if I chase you.", "That's just a threat dressed up as honesty.", "So this is an ultimatum?", "Fine. Then don't. See if I chase you.", "That's a threat dressed up as honesty."],
    silent: ["Okay.", "I hear you.", "Alright then.", "Okay.", "I hear you.", "Alright."] },

  { hani: ["I want to believe you. I genuinely do. I just don't know how much of that is hope and how much is habit.", "I want to believe you. I really do. I just can't tell if it's hope or just habit.", "I want to believe you. I just don't know how much is hope and how much is habit."], subtext: "(He's distinguishing between them for the first time. It scares him.)", conflict: "Dismissing his doubt", salvation: false,
    soft: ["Then let it be hope. Give me the chance to make it more than just habit.", "That doubt is fair. I'll be patient while I prove it's worth the risk.", "Hope, habit — I'll take either, if it means you let me show up differently.", "Then let it be hope. Let me make it more than habit.", "That doubt is fair. I'll be patient while I prove it.", "Hope or habit — I'll take either, if you let me show up differently."],
    aggressive: ["You're overanalyzing this into the ground.", "Either you believe me or you don't. Just pick.", "I can't argue you into trusting me. This is exhausting.", "You're overanalysing this to death.", "Believe me or don't. Just pick one.", "I can't argue you into trusting me."],
    silent: ["Okay.", "Sure.", "If you say so.", "Okay.", "Sure.", "If you say so."] },

  { hani: ["Okay. I'll try. But I need you to understand - I'm not the same person I was when we started. Some of that is gone.", "Okay. I'll try. But understand — I'm not who I was when we started. Some of that's gone.", "Alright. I'll try. But I'm not the same person anymore. Some of me is just gone."], subtext: "(He's giving her one last opening. He doesn't know if she'll walk through it.)", conflict: "Acknowledging change without engaging", salvation: true,
    soft: ["I don't want the old you. I want to actually know who you are now. Let me.", "Some of that's gone because of how I treated it. I'll be careful with whoever you are now.", "Thank you for trying. I'll show up for the real you, not some memory of you.", "I don't want the old you. I want who you are now. Let me know him.", "Some of that's gone because of how I treated it. I'll be gentle with whoever's left.", "Thank you for trying. I'll show up for the real you."],
    aggressive: ["Everyone changes. Don't make it sound so dramatic.", "So you're a whole different person now? Convenient timing.", "Fine, whatever. People grow up.", "Everyone changes. Don't make it dramatic.", "A whole new person now? Convenient.", "Fine. People grow up."],
    silent: ["Okay.", "Understood.", "Noted.", "Okay.", "Understood.", "Noted."] },

  { hani: ["Then - okay. Let's try. But slowly. I can't do another fall.", "Then okay. Let's try. Slowly, though. I can't survive another fall.", "Alright. Let's try. But slow. I can't go through another fall."], subtext: "(He means: I can't survive losing this twice.)", conflict: "Final rejection", salvation: true,
    soft: ["Slowly. I promise. I'd rather rebuild this carefully than risk dropping you again.", "No more falls. We go at whatever pace lets you breathe around me.", "Then slowly. Thank you for even opening the door again. I won't waste it.", "Slowly. I promise. I'd rather rebuild careful than drop you again.", "No more falls. Whatever pace lets you breathe around me.", "Then slowly. Thank you for opening the door. I won't waste it."],
    aggressive: ["Slow's fine, just don't keep me on probation forever.", "Okay, but I'm not walking on eggshells either.", "Let's not make this more fragile than it has to be.", "Slow's fine, just no endless probation.", "Okay, but I'm not on eggshells either.", "Let's not make this more fragile than it needs to be."],
    silent: ["Okay.", "Sure.", "Fine.", "Okay.", "Sure.", "Fine."] }
];
